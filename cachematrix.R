...
## If the inverse has already been calculated (and the matrix has not changed), then cacheSolve should retrieve the inverse matrix from the cache.
...
## Otherwise, it calculates the inverse of the matrix and sets the value of it in the cache via the setinv function.
